...
@section('container')
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
      <h1 class="h2">Master Data Grup Layanan</h1>
    </div>
          ...
          @foreach ($list as $item)    
            <tr>
              ...
              <td>
                ...
                <a href="/dashboard/gruplayanan/{{ $item->id }}/edit" class="badge bg-warning"><span data-feather="edit"></span></a>
                <form action="/dashboard/gruplayanan/{{ $item->id }}" method="post" class="d-inline">
                @method('delete')
                @csrf
